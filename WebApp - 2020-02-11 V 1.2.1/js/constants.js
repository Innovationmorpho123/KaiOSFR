...
const CONST_LICENSE_FILE_NAME = CONST_FOLDER_NAME + 'LicenseFile.txt'
...
const CONST_CLIENT_ID = 'testuser';
const CONST_CLIENT_SECRET = 'F401MTb6QMNy8VFDMYDJ0dBQZepKDeHbTTCXRGaL+gFOCAomRITeZeJoQG3+CU2YNT2JXVzVgcZWD5LQNASqJA==';
...
const BASE_URL = 'https://frdevicessit.jio.com:443/bioserver-app/v2/'

const BASE_URL_FOR_TOKEN = 'https://frdevicessit.jio.com:443/'
...
const TOKEN_API = 'token-app/v1/authentication'
